...
PennController.Sequence("welcome", "info", "instructions","examples", randomize("practice"), "start", randomize("trials11"),"attentionCheck", randomize("trials12"), "send" ,"final")
...
newHtml("consent", "explanation.html")
    .print()
,
newButton("Weiter", "&Uuml;bungen beginnen")
    .print()
    .wait()  
    )
...
//Examples Screen
    ...
    variable => PennController("practice",
     ...
     ,
                              ...
                              newText("question", "Wie akzeptabel ist der gerade gelesene Satz angesichts des Kontexts? ")
...
PennController.Template(
    PennController.GetTable("list11.csv"),  // load your csv
    variable => PennController("trials11",
                                defaultText
                               .settings.css("font-size", "30")
                               ,
                              newTimer(500)
...
PennController("attentionCheck",
    newText("attentionCheck", "Bitte w&auml;hlen Sie auf der untenstehenden Skala achtunddrei&szlig;ig aus!")
    .settings.center()
    .settings.bold()
...
PennController.Template(
    PennController.GetTable("list12.csv"),  // load your csv
    variable => PennController("trials12",
                                defaultText
                               .settings.css("font-size", "30")
                               ,
                              newTimer(500)
